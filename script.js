...
async function display(latitude, longitude) {
  ...
  try {
    ...
    hideLoading(loader);
    notifyTemp(Math.round(hourly_result.current.temp), daily_result.city.name, daily_result);
...
function displayWeatherInfo(hourly_result, daily_result) {
  ...
  let {
      ...
      document.getElementById("cur_temp").innerHTML = `${Math.round(
        temp
      )}&deg;C`;
...
hourly_info.map((items) => {
  ...
  if (conditons == "01d" || conditons == "01n") {
    ...
    hour_icone =
      '<img src="assist/cloudy(1).png" width="40px" alt="icon"/>';
    ...
    hour_icone =
      '<img src="assist/heavy-rain.png" width="40px" alt="icon"/>';
  } else if (conditons == "11d" || conditons == "11n") {
    hour_icone =
      ' <img src="assist/thunder.png" width="40px" alt="icon"/>';
  } else if (conditons == "13d" || conditons == "13n") {
    hour_icone =
      ' <img src="assist/snowing.png" width="40px" alt="icon"/>';
  } else {
